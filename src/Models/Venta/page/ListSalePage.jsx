...
import { usePaginateStore, useSaleStore } from '../../../hooks';
...
export const ListSalePage = () => {
    const { startGetSale, startGetSearchSale } =  useSaleStore(); 
    const { data, currentPage, totalPages, searchPage, 
            createPageURL, handleInputChange, generatePagination } =  usePaginateStore(startGetSale);
    ...
    items-center justify-center dark:bg-dark-secondary-900">
        ...
        dark:bg-dark-secondary-100 p-8 transition-all duration-300 ease-in-out'>
            <div className='flex items-center justify-between mb-5'>
                ...
                dark:bg-dark-primary">Create Venta</Link>
            </div>
            <SearchPage
