...
import { useClientStore, usePaginateStore } from '../../../hooks';
...
export const ListClientPage = () => {
  ...
  const { startGetClient, startGetSearchClient, DeleteClient } =  useClientStore(); 
  const { data, currentPage, totalPages, searchPage, 
          createPageURL, handleInputChange, generatePagination } =  usePaginateStore(startGetClient, startGetSearchClient);
    ...
    items-center justify-center dark:bg-dark-secondary-900">
        ...
        dark:bg-dark-secondary-100 p-8 transition-all duration-300 ease-in-out'>
            <div className='flex items-center justify-between mb-5'>
                ...
                dark:bg-dark-primary">Crear Cliente</Link>
            </div>
            <SearchPage
            searchParams = {searchPage}
            handleInputChange={handleInputChange}/>

            <ListClient data={data} DeleteClient={DeleteClient}/>
